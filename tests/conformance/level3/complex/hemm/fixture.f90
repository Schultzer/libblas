      program fixture
         ...
         call addcase(root, '0', 'l', 'u', 4, 0, (0.2_8, 0.8_8), a, 6, b, 6, (0.7_8, -0.3_8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '1', 'l', 'u', 0, 6, (0.2_8, 0.8_8), a, 6, b, 6, (0.7_8, -0.3_8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '2', 'l', 'u', 4, 6, (0._8, 0._8), a, 6, b, 6, (1._8, 0._8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '4', 'l', 'u', 4, 6, (0._8, 0._8), a, 6, b, 6, (0._8, 0._8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '5', 'l', 'u', 4, 6, (0._8, 0._8), a, 6, b, 6, (-0.1_8, 0.5_8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '6', 'l', 'u', 4, 6, (0.2_8, -0.8_8), a, 6, b, 6, (-0.4_8, 0.5_8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '7', 'l', 'u', 4, 6, (0.2_8, -0.8_8), a, 6, b, 6, (0._8, 0._8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '8', 'l', 'l', 4, 6, (0.2_8, -0.8_8), a, 6, b, 6, (0.6_8, 0.4_8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '9', 'l', 'l', 4, 6, (0.2_8, -0.8_8), a, 6, b, 6, (0._8, 0._8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '10', 'r', 'u', 4, 6, (0.2_8, -0.8_8), a, 6, b, 6, (0.1_8, 0.5_8), c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '11', 'r', 'l', 4, 6, (0.2_8, -0.8_8), a, 6, b, 6, (0._8, 0._8), c, 6)
         call print(root)
      contains
         subroutine addcase(root, ncase, side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc)
            ...
            complex*16 alpha, beta, a(lda, n), b(ldb, n), c(ldc, n)
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level3/complex/hemm.json')
