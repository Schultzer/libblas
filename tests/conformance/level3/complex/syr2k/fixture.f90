program fixture
   ...
   call addcase(root, '0', 'u', 'n', 4, 6, (0._8, 0._8), a, 6, b, 6, (1._8, 0._8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '1', 'u', 'n', 4, 6, (0._8, 0._8), a, 6, b, 6, (0.5_8, 0.5_8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '2', 'l', 'n', 4, 6, (0._8, 0._8), a, 6, b, 6, (0._8, 0._8), c, 6)
   ...
   a(1, 1) = (0._8, 0._8)
   b(1, 1) = (0._8, 0._8)
   call addcase(root, '3', 'u', 'n', 4, 6, (0.2_8, -0.6_8), a, 6, b, 6, (0._8, 0._8), c, 6)
   ...
   a(1, 1) = (0._8, 0._8)
   b(1, 1) = (0._8, 0._8)
   call addcase(root, '4', 'u', 'n', 4, 6, (0.2_8, -0.6_8), a, 6, b, 6, (-0.4_8, 0._8), c, 6)
   ...
   a(1, 1) = (0._8, 0._8)
   b(1, 1) = (0._8, 0._8)
   call addcase(root, '5', 'l', 'n', 4, 6, (0.2_8, -0.6_8), a, 6, b, 6, (1_8, 0._8), c, 6)
   ...
   a(1, 1) = (0._8, 0._8)
   b(1, 1) = (0._8, 0._8)
   call addcase(root, '6', 'u', 't', 4, 6, (0.2_8, -0.6_8), a, 6, b, 6, (0._8, 0._8), c, 6)
   ...
   a(1, 1) = (0._8, 0._8)
   b(1, 1) = (0._8, 0._8)
   call addcase(root, '7', 'l', 't', 4, 6, (0.2_8, -0.6_8), a, 6, b, 6, (0.5_8, 0.5_8), c, 6)
...
contains
   ...
   subroutine print(root)
      ...
      call json%print(root, './tests/fixtures/level3/complex/syr2k.json')
      if (json%failed()) then
