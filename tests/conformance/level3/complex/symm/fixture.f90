program fixture
   ...
   call addcase(root, '0', 'l', 'u', 4, 5, (0._8, 0._8), a, 6, b, 6, (1_8, 0._8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '1', 'l', 'u', 4, 5, (0._8, 0._8), a, 6, b, 6, (0._8, 0._8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '2', 'l', 'u', 4, 5, (0._8, 0._8), a, 6, b, 6, (0._8, 0.5_8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '3', 'l', 'u', 4, 5, (0.2_8, 0.8_8), a, 6, b, 6, (0._8, 0._8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '4', 'l', 'u', 4, 5, (0.2_8, 0.8_8), a, 6, b, 6, (-0.45_8, 0.2_8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '5', 'l', 'l', 4, 5, (0.2_8, 0.8_8), a, 6, b, 6, (0._8, 0._8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '6', 'l', 'l', 4, 5, (0.2_8, 0.8_8), a, 6, b, 6, (0.2_8, -0.3_8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '7', 'r', 'u', 4, 5, (0.2_8, 0.8_8), a, 6, b, 6, (0._8, 0._8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '8', 'r', 'u', 4, 5, (0.2_8, 0.8_8), a, 6, b, 6, (0.1_8, 0.9_8), c, 6)

   call copy(m6x6, a, 6, 6)
   call copy(m6x6, b, 6, 6)
   call copy(m6x6, c, 6, 6)
   call addcase(root, '9', 'r', 'l', 4, 5, (0.2_8, 0.8_8), a, 6, b, 6, (0.1_8, 0.9_8), c, 6)
...
contains
   ...
   subroutine print(root)
      ...
      call json%print(root, './tests/fixtures/level3/complex/symm.json')
      if (json%failed()) then
