        program fixture
           ...
           complex*16 m6x6(6, 6), a(6, 6), c(6, 6)
           ...
           call addcase(root, '0', 'u', 'n', 4, 6, (0._8, 0._8), a, 6, (1._8, 0._8), c, 6)

           call copy(m6x6, a, 6, 6)
           call copy(m6x6, c, 6, 6)
           call addcase(root, '1', 'u', 'n', 4, 6, (0._8, 0._8), a, 6, (0.2_8, -0.3_8), c, 6)

           call copy(m6x6, a, 6, 6)
           call copy(m6x6, c, 6, 6)
           call addcase(root, '2', 'l', 'n', 4, 6, (0._8, 0._8), a, 6, (0.2_8, -0.3_8), c, 6)

           call copy(m6x6, a, 6, 6)
           call copy(m6x6, c, 6, 6)
           a(1, 1) = (0._8, 0._8)
           call addcase(root, '3', 'l', 'n', 4, 6, (0._8, 0._8), a, 6, (0._8, 0._8), c, 6)

           call copy(m6x6, a, 6, 6)
           call copy(m6x6, c, 6, 6)
           a(1, 1) = (0._8, 0._8)
           call addcase(root, '4', 'l', 'n', 4, 6, (0.2_8, 0.8_8), a, 6, (0.2_8, -0.3_8), c, 6)

           call copy(m6x6, a, 6, 6)
           call copy(m6x6, c, 6, 6)
           a(1, 1) = (0._8, 0._8)
           call addcase(root, '5', 'l', 'n', 4, 6, (0.2_8, 0.8_8), a, 6, (0._8, 0._8), c, 6)

           call copy(m6x6, a, 6, 6)
           call copy(m6x6, c, 6, 6)
           a(1, 1) = (0._8, 0._8)
           call addcase(root, '6', 'l', 'n', 4, 6, (0.2_8, 0.8_8), a, 6, (1._8, 0._8), c, 6)

           call copy(m6x6, a, 6, 6)
           call copy(m6x6, c, 6, 6)
           a(1, 1) = (0._8, 0._8)
           call addcase(root, '7', 'u', 't', 4, 6, (0.2_8, 0.8_8), a, 6, (-0.3_8, 0.7_8), c, 6)

           call copy(m6x6, a, 6, 6)
           call copy(m6x6, c, 6, 6)
           a(1, 1) = (0._8, 0._8)
           call addcase(root, '8', 'l', 't', 4, 6, (0.2_8, 0.8_8), a, 6, (0._8, 0._8), c, 6)
        ...
        contains
           subroutine addcase(root, ncase, uplo, trans, n, k, alpha, a, lda, beta, c, ldc)
              ...
              character(len=*) ncase
              integer n, k, lda, ldc
              complex*16 alpha, beta, a(lda, n), c(ldc, n)
           ...
           subroutine print(root)
              ...
              call json%print(root, './tests/fixtures/level3/complex/syrk.json')
