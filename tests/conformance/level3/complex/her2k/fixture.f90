      PROGRAM fixture
         ...
         call addcase(root, '0', 'u', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 0.3_8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         a(1, 1) = (0._8, 0._8)
         call addcase(root, '1', 'u', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 0._8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         b(1, 1) = (0._8, 0._8)
         call addcase(root, '2', 'u', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 0._8, c, 6)
         ...
         a(1, 1) = (0._8, 0._8)
         b(1, 1) = (0._8, 0._8)
         call addcase(root, '3', 'u', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 0._8, c, 6)
         ...
         a(1, 1) = (0._8, 0._8)
         b(1, 1) = (0._8, 0._8)
         call addcase(root, '4', 'u', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 1._8, c, 6)
         ...
         a(1, 1) = (0._8, 0._8)
         b(1, 1) = (0._8, 0._8)
         call addcase(root, '5', 'l', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 1._8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '6', 'l', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 1._8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '7', 'l', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 0.5_8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '8', 'l', 'n', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 0._8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '9', 'u', 'c', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 0._8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '10', 'l', 'c', 5, 4, (0.2_8, 0.8_8), a, 6, b, 6, 0.5_8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '11', 'l', 'c', 5, 4, (0._8, 0._8), a, 6, b, 6, 1._8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '12', 'u', 'c', 5, 4, (0._8, 0._8), a, 6, b, 6, 0.8_8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '13', 'u', 'c', 5, 4, (0._8, 0._8), a, 6, b, 6, 0._8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '14', 'l', 'c', 5, 4, (0._8, 0._8), a, 6, b, 6, 0.8_8, c, 6)

         call copy(m6x6, a, 6, 6)
         call copy(m6x6, b, 6, 6)
         call copy(m6x6, c, 6, 6)
         call addcase(root, '15', 'l', 'c', 5, 4, (0._8, 0._8), a, 6, b, 6, 0._8, c, 6)
      ...
      contains
         subroutine addcase(root, ncase, uplo, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc)
            ...
            complex*16 alpha, a(lda, n), b(ldb, n), c(ldc, n)
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level3/complex/her2k.json')
