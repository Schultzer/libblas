      program fixture
         ...
         double precision x(6), a(6, 6), ac(6, 6)
         ...
         a = ac
         call addcase(root, '0', 'u', 6, 1._8, x, 1, a, 6)

         a = ac
         call addcase(root, '1', 'l', 6, 1._8, x, -1, a, 6)

         x(2) = 0
         x(4) = 0
         a = ac
         call addcase(root, '2', 'l', 6, 1.5_8, x, 1, a, 6)

         a = ac
         call addcase(root, '3', 'u', 6, 1.5_8, x, 1, a, 6)
      ...
      contains
         subroutine addcase(root, ncase, uplo, n, alpha, x, incx, a, lda)
            ...
            integer n, lda, incx
            double precision alpha, x(6), a(6, 6)
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level2/syr.json')
