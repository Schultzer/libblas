      program fixture
         ...
         double precision x(6), v6(6), upper(6, 6), lower(6, 6)
         ...
         x = v6
         x(1) = 0
         call addcase(root, '0', 'u', 'n', 'n', 6, upper, 6, x, -1)
         ...
         x = v6
         x(3) = 0
         call addcase(root, '2', 'u', 't', 'n', 6, upper, 6, x, 1)

         x = v6
         x(3) = 0
         call addcase(root, '3', 'u', 't', 'u', 6, upper, 6, x, 1)

         x = v6
         x(1) = 0
         call addcase(root, '4', 'l', 'n', 'n', 6, lower, 6, x, 1)

         x = v6
         x(3) = 0
         call addcase(root, '5', 'l', 'n', 'u', 6, lower, 6, x, 1)
         ...
         x = v6
         x(3) = 0
         call addcase(root, '8', 'l', 't', 'u', 0, lower, 6, x, 1)
      ...
      contains
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level2/trsv.json')
