      program fixture
         ...
         ! SOME OF THESE FIXTURE DON'T MATCH JS
         ...
         x = xc
         call addcase(root, '2', 'l', 'n', 'n', 6, lower, x, 1)

         x = xc
         call addcase(root, '3', 'l', 'n', 'u', 6, lower, x, 1)

         x = xc
         call addcase(root, '4', 'u', 't', 'n', 6, upper, x, -1)

         x = xc
         call addcase(root, '5', 'u', 't', 'u', 6, upper, x, -1)
      ...
      contains
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level2/tpmv.json')
