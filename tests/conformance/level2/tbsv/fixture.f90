      program fixture
         ...
         double precision x(6), xc(6), upper_packed(6, 6), lower_packed(6, 6)
         data((lower_packed(i, j), i=1, 6), j=1, 6)/&
        &1.2629542848807933,&
        &-0.3262333607056494,&
        &1.3297992629225006,&
        &1.2724293214294047,&
        ...
        &0,&
        &0/
         data((upper_packed(i, j), i=1, 6), j=1, 6)/&
         &0,&
         &0,&
         &0,&
         &0,&
        ...
        &0.5503933584550523/
         ...
         x = xc
         x(3) = 0
         call addcase(root, '0', 'u', 'n', 'n', 6, 5, upper_packed, 6, x, -1)

         x = xc
         x(3) = 0
         x(6) = 0
         call addcase(root, '1', 'u', 'n', 'u', 6, 5, upper_packed, 6, x, 1)

         x = xc
         x(3) = 0
         call addcase(root, '2', 'u', 't', 'n', 6, 5, upper_packed, 6, x, 1)

         x = xc
         x(3) = 0
         call addcase(root, '3', 'u', 't', 'n', 6, 5, upper_packed, 6, x, 1)

         x = xc
         x(3) = 0
         x(1) = 0
         call addcase(root, '4', 'l', 'n', 'n', 6, 5, lower_packed, 6, x, 1)

         x = xc
         x(3) = 0
         call addcase(root, '5', 'l', 'n', 'u', 6, 5, lower_packed, 6, x, 1)

         x = xc
         x(3) = 0
         call addcase(root, '6', 'l', 't', 'n', 6, 5, lower_packed, 6, x, 1)

         x = xc
         x(3) = 0
         call addcase(root, '7', 'l', 't', 'u', 6, 5, lower_packed, 6, x, 1)
      ...
      contains
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level2/tbsv.json')
