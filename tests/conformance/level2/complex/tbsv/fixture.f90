      PROGRAM fixture
         ...
         x = v6
         x(6) = 0
         call addcase(root, '0', 'u', 'n', 'n', 6, 3, a, 6, x, 1)

         x = v6
         x(1) = 0
         call addcase(root, '1', 'u', 'n', 'u', 6, 3, a, 6, x, 1)

         x = v6
         x(1) = 0
         call addcase(root, '2', 'l', 'n', 'n', 6, 3, a, 6, x, 1)

         x = v6
         x(1) = 0
         x(3) = 0
         call addcase(root, '3', 'l', 'n', 'u', 6, 3, a, 6, x, 1)

         x = v6
         x(1) = 0
         x(3) = 0
         call addcase(root, '4', 'u', 't', 'n', 6, 3, a, 6, x, 1)

         x = v6
         x(4) = 0
         x(2) = 0
         call addcase(root, '5', 'u', 't', 'u', 6, 3, a, 6, x, 1)

         x = v6
         x(4) = 0
         x(2) = 0
         call addcase(root, '6', 'l', 't', 'n', 6, 3, a, 6, x, 1)

         x = v6
         x(4) = 0
         x(2) = 0
         call addcase(root, '7', 'l', 't', 'u', 6, 3, a, 6, x, 1)

         x = v6
         x(4) = 0
         x(2) = 0
         call addcase(root, '8', 'u', 'c', 'n', 6, 3, a, 6, x, -1)

         x = v6
         x(4) = 0
         x(2) = 0
         call addcase(root, '9', 'u', 'c', 'u', 6, 3, a, 6, x, 1)

         x = v6
         x(4) = 0
         x(2) = 0
         call addcase(root, '10', 'l', 'c', 'n', 6, 3, a, 6, x, 1)

         x = v6
         x(4) = 0
         x(2) = 0
         call addcase(root, '11', 'l', 'c', 'u', 6, 3, a, 6, x, 1)

         x = v6
         x(4) = 0
         x(2) = 0
         call addcase(root, '12', 'l', 'c', 'u', 0, 3, a, 6, x, 1)
      ...
      contains
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level2/complex/tbsv.json')
