      program fixture
         ...
         complex*16 alpha, upper(6, 6), lower(6, 6), a(6, 6), x(6), y(6), v6(6)
         ...
         x(2) = 0
         y(4) = 0
         call addcase(root, '0', 'u', 6, (0.2_8, 0.8_8), x, 1, y, 1, a, 6)

         a = upper
         call addcase(root, '1', 'l', 6, (0.2_8, 0.8_8), x, -1, y, -1, a, 6)

         a = upper
         call addcase(root, '2', 'l', 6, (0._8, 0._8), x, -1, y, -1, a, 6)
      ...
      contains
         subroutine addcase(root, ncase, uplo, n, alpha, x, incx, y, incy, a, lda)
            ...
            complex*16 alpha, a(6, 6), x(6), y(6)
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level2/complex/her2.json')
