      program fixture
         ...
         y = v
         call addcase(root, '0', 'n', 6, 8, (0.8_8, 0.2_8), a, 6, x, 1, (0.2_8, 0.8_8), y, 1)

         y = v
         call addcase(root, '1', 'n', 6, 8, (0.8_8, 0.2_8), a, 6, x, -1, (0._8, 0._8), y, -1)

         y = v
         call addcase(root, '2', 'n', 6, 8, (0.8_8, 0.2_8), a, 6, x, 1, (1._8, 0._8), y, 1)

         y2 = x
         call addcase(root, '3', 't', 6, 8, (0.8_8, 0.2_8), a, 6, v, 1, (1._8, 0._8), y2, 1)

         y2 = x
         call addcase(root, '4', 'c', 6, 8, (0.8_8, 0.2_8), a, 6, v, 1, (1._8, 0._8), y2, 1)

         y = v
         call addcase(root, '5', 'n', 6, 8, (0._8, 0._8), a, 6, x, 1, (0.2_8, 0.8_8), y, 1)

         y = v
         call addcase(root, '6', 'n', 6, 8, (0._8, 0._8), a, 6, x, 1, (1._8, 0._8), y, 1)
      ...
      contains
         ...
         subroutine print(root)
            ...
            call json%print(root, './tests/fixtures/level2/complex/gemv.json')
