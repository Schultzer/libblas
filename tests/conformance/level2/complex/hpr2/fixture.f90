program fixture
   ...
   complex*16 alpha, lower(21), upper(21), ap(21), v6(6), x(6), y(6)
   data(upper(I), i=1, 21)/&
   ...
   x(4) = 0
   x(2) = 0
   call addcase(root, '0', 'u', 6, (0.2_8, 0.8_8), x, 1, y, 1, ap)

   ap = lower
   call addcase(root, '1', 'l', 6, (0.2_8, 0.8_8), x, -1, y, -1, ap)

   ap = lower
   call addcase(root, '2', 'l', 6, (0._8, 0._8), x, -1, y, -1, ap)
...
contains
   subroutine addcase(root, ncase, uplo, n, alpha, x, incx, y, incy, ap)
      ...
      integer n, incx, incy
      complex*16 alpha, ap(21), x(6), y(6)
   ...
   subroutine print(root)
      ...
      call json%print(root, './tests/fixtures/level2/complex/hpr2.json')
      if (json%failed()) then
